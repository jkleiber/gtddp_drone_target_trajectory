...
TargetTrajectory *target_traj = new FigureEight(0.9, 0.9, 1.0, 0.4);  //fly a figure eight at 0.4 rad/sec
// TargetTrajectory *target_traj = new InclinedCircle(0.9, 0.8, 0.3, 0.4);
